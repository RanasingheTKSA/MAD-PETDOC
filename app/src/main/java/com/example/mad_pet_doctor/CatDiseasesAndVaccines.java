...
public class CatDiseasesAndVaccines extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cat_diseasesandvaccines);
        ...
        HomeChip1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(CatDiseasesAndVaccines.this, ActivityMainSideBar.class));
            }
        });
