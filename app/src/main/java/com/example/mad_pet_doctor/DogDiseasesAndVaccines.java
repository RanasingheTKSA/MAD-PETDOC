...
public class DogDiseasesAndVaccines extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dog_diseasesandvaccines);
        ...
        HomeChip1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(DogDiseasesAndVaccines.this, ActivityMainSideBar.class));
            }
        });
