...
public class IntroductionDog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.introduction_dog);
        ...
        HomeChip1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(IntroductionDog.this, ActivityMainSideBar.class));
            }
        });
