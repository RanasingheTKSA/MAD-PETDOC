...
public class CatOriginOfBreed extends AppCompatActivity {

    private Chip HomeChip1, HomeChip2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.cat_originofbreed);
        ...
        HomeChip1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(CatOriginOfBreed.this, ActivityMainSideBar.class));
            }
        });
