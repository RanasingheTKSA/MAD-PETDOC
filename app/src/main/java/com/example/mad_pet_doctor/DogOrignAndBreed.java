...
public class DogOrignAndBreed extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dog_originofbreed);
        ...
        HomeChip1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(DogOrignAndBreed.this, ActivityMainSideBar.class));
            }
        });
