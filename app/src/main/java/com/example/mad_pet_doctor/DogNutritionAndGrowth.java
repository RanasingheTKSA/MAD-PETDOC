...
public class DogNutritionAndGrowth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dog_nuritionandgrowth);
        ...
        HomeChip1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(DogNutritionAndGrowth.this, ActivityMainSideBar.class));
            }
        });
